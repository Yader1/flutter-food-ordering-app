        ...
        slivers: [
          SliverAppBar(
            ...
            bottom: PreferredSize(
              ...
              child: Container(
                child: Center(child: BigText(text: "Chinese Side", size: Dimenciones.font26,)),
      ...
      bottomNavigationBar: Column(
        ...
        children: [
          Container(
            ...
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
            AppIcon(iconSize: Dimenciones.iconSize24, iconColor: Colors.white ,backgroundColor: AppColors.mainColor ,icon: Icons.remove),
            BigText(text: "\$12.88 " + " X " + " 0 ", color: AppColors.mainBlackColor, size: Dimenciones.font26,),
            AppIcon(iconSize: Dimenciones.iconSize24, iconColor: Colors.white ,backgroundColor: AppColors.mainColor ,icon: Icons.add),
            ],),
          ),
          Container(
