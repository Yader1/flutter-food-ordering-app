...
class DrinkFoodDetail extends StatelessWidget {
  final int pageId;
  final String page;
  const DrinkFoodDetail({Key? key, required this.pageId, required this.page}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<DrinksProductController>().drinksProductList[pageId];
