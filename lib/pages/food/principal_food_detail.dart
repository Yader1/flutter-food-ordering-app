...
class PrincipalFoodDetail extends StatelessWidget {
  final int pageId;
  final String page;
  const PrincipalFoodDetail({Key? key, required this.pageId, required this.page}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var product = Get.find<PrincipalProductController>().principalProductList[pageId];
